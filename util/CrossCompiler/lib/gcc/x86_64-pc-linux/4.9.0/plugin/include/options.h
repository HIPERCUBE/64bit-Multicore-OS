...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1066,            /* -m128bit-long-double */
  OPT_m16 = 1067,                            /* -m16 */
  OPT_m32 = 1068,                            /* -m32 */
  OPT_m3dnow = 1069,                         /* -m3dnow */
  OPT_m3dnowa = 1070,                        /* -m3dnowa */
  OPT_m64 = 1071,                            /* -m64 */
  OPT_m80387 = 1072,                         /* -m80387 */
  OPT_m8bit_idiv = 1073,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1074,             /* -m96bit-long-double */
  OPT_mabi_ = 1075,                          /* -mabi= */
  OPT_mabm = 1076,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1077,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1078,                 /* -maddress-mode= */
  OPT_madx = 1079,                           /* -madx */
  OPT_maes = 1080,                           /* -maes */
  OPT_malign_double = 1081,                  /* -malign-double */
  OPT_malign_functions_ = 1082,              /* -malign-functions= */
  OPT_malign_jumps_ = 1083,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1084,                  /* -malign-loops= */
  OPT_malign_stringops = 1085,               /* -malign-stringops */
  OPT_mandroid = 1086,                       /* -mandroid */
  OPT_march_ = 1087,                         /* -march= */
  OPT_masm_ = 1088,                          /* -masm= */
  OPT_mavx = 1089,                           /* -mavx */
  OPT_mavx2 = 1090,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1091,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1092,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1093,                      /* -mavx512cd */
  OPT_mavx512er = 1094,                      /* -mavx512er */
  OPT_mavx512f = 1095,                       /* -mavx512f */
  OPT_mavx512pf = 1096,                      /* -mavx512pf */
  OPT_mbionic = 1097,                        /* -mbionic */
  OPT_mbmi = 1098,                           /* -mbmi */
  OPT_mbmi2 = 1099,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1100,                  /* -mbranch-cost= */
  OPT_mcld = 1101,                           /* -mcld */
  OPT_mcmodel_ = 1102,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1103, */                    /* -mcpu= */
  OPT_mcrc32 = 1104,                         /* -mcrc32 */
  OPT_mcx16 = 1105,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1106,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1107,            /* -mdump-tune-features */
  OPT_mf16c = 1108,                          /* -mf16c */
  OPT_mfancy_math_387 = 1109,                /* -mfancy-math-387 */
  OPT_mfentry = 1110,                        /* -mfentry */
  OPT_mfma = 1111,                           /* -mfma */
  OPT_mfma4 = 1112,                          /* -mfma4 */
  OPT_mforce_drap = 1113,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1114,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1115,                       /* -mfpmath= */
  OPT_mfsgsbase = 1116,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1117, */              /* -mfused-madd */
  OPT_mfxsr = 1118,                          /* -mfxsr */
  OPT_mglibc = 1119,                         /* -mglibc */
  OPT_mhard_float = 1120,                    /* -mhard-float */
  OPT_mhle = 1121,                           /* -mhle */
  OPT_mieee_fp = 1122,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1123,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1124,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1125,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1126, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1127,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1128,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1129,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1130,                /* -mlong-double-80 */
  OPT_mlwp = 1131,                           /* -mlwp */
  OPT_mlzcnt = 1132,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1133,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1134,              /* -mmemset-strategy= */
  OPT_mmmx = 1135,                           /* -mmmx */
  OPT_mmovbe = 1136,                         /* -mmovbe */
  OPT_mms_bitfields = 1137,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1138,            /* -mno-align-stringops */
  OPT_mno_default = 1139,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1140,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1141,                  /* -mno-push-args */
  OPT_mno_red_zone = 1142,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1143,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1144,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1145,                          /* -mpc32 */
  OPT_mpc64 = 1146,                          /* -mpc64 */
  OPT_mpc80 = 1147,                          /* -mpc80 */
  OPT_mpclmul = 1148,                        /* -mpclmul */
  OPT_mpopcnt = 1149,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1150,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1151,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1152,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1153,                        /* -mprfchw */
  OPT_mpush_args = 1154,                     /* -mpush-args */
  OPT_mrdrnd = 1155,                         /* -mrdrnd */
  OPT_mrdseed = 1156,                        /* -mrdseed */
  OPT_mrecip = 1157,                         /* -mrecip */
  OPT_mrecip_ = 1158,                        /* -mrecip= */
  OPT_mred_zone = 1159,                      /* -mred-zone */
  OPT_mregparm_ = 1160,                      /* -mregparm= */
  OPT_mrtd = 1161,                           /* -mrtd */
  OPT_mrtm = 1162,                           /* -mrtm */
  OPT_msahf = 1163,                          /* -msahf */
  OPT_msha = 1164,                           /* -msha */
  OPT_msoft_float = 1165,                    /* -msoft-float */
  OPT_msse = 1166,                           /* -msse */
  OPT_msse2 = 1167,                          /* -msse2 */
  OPT_msse2avx = 1168,                       /* -msse2avx */
  OPT_msse3 = 1169,                          /* -msse3 */
  OPT_msse4 = 1170,                          /* -msse4 */
  OPT_msse4_1 = 1171,                        /* -msse4.1 */
  OPT_msse4_2 = 1172,                        /* -msse4.2 */
  OPT_msse4a = 1173,                         /* -msse4a */
  /* OPT_msse5 = 1174, */                    /* -msse5 */
  OPT_msseregparm = 1175,                    /* -msseregparm */
  OPT_mssse3 = 1176,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1177,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1178,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1179,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1180,            /* -mstringop-strategy= */
  OPT_mtbm = 1181,                           /* -mtbm */
  OPT_mtls_dialect_ = 1182,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1183,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1184,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1185,                         /* -mtune= */
  OPT_muclibc = 1186,                        /* -muclibc */
  OPT_mveclibabi_ = 1187,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1188,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1189,                    /* -mvzeroupper */
  OPT_mx32 = 1190,                           /* -mx32 */
  OPT_mxop = 1191,                           /* -mxop */
  OPT_mxsave = 1192,                         /* -mxsave */
  OPT_mxsaveopt = 1193,                      /* -mxsaveopt */
  OPT_n = 1194,                              /* -n */
  OPT_no_canonical_prefixes = 1195,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1196,              /* -no-integrated-cpp */
  OPT_nocpp = 1197,                          /* -nocpp */
  OPT_nodefaultlibs = 1198,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1199,                   /* -nostartfiles */
  OPT_nostdinc = 1200,                       /* -nostdinc */
  OPT_nostdinc__ = 1201,                     /* -nostdinc++ */
  OPT_nostdlib = 1202,                       /* -nostdlib */
  OPT_o = 1203,                              /* -o */
  OPT_p = 1204,                              /* -p */
  OPT_pass_exit_codes = 1205,                /* -pass-exit-codes */
  /* OPT_pedantic = 1206, */                 /* -pedantic */
  OPT_pedantic_errors = 1207,                /* -pedantic-errors */
  OPT_pg = 1208,                             /* -pg */
  OPT_pie = 1209,                            /* -pie */
  OPT_pipe = 1210,                           /* -pipe */
  OPT_posix = 1211,                          /* -posix */
  OPT_print_file_name_ = 1212,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1213,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1214,          /* -print-multi-directory */
  OPT_print_multi_lib = 1215,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1216,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1217,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1218,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1219,               /* -print-prog-name= */
  OPT_print_search_dirs = 1220,              /* -print-search-dirs */
  OPT_print_sysroot = 1221,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1222,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1223,                        /* -profile */
  OPT_pthread = 1224,                        /* -pthread */
  OPT_quiet = 1225,                          /* -quiet */
  OPT_r = 1226,                              /* -r */
  OPT_rdynamic = 1227,                       /* -rdynamic */
  OPT_remap = 1228,                          /* -remap */
  OPT_s = 1229,                              /* -s */
  OPT_s_bc_abi = 1230,                       /* -s-bc-abi */
  OPT_save_temps = 1231,                     /* -save-temps */
  OPT_save_temps_ = 1232,                    /* -save-temps= */
  OPT_shared = 1233,                         /* -shared */
  OPT_shared_libgcc = 1234,                  /* -shared-libgcc */
  /* OPT_specs = 1235, */                    /* -specs */
  OPT_specs_ = 1236,                         /* -specs= */
  OPT_static = 1237,                         /* -static */
  OPT_static_libasan = 1238,                 /* -static-libasan */
  OPT_static_libgcc = 1239,                  /* -static-libgcc */
  OPT_static_libgcj = 1240,                  /* -static-libgcj */
  OPT_static_libgfortran = 1241,             /* -static-libgfortran */
  OPT_static_libgo = 1242,                   /* -static-libgo */
  OPT_static_liblsan = 1243,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1244,               /* -static-libstdc++ */
  OPT_static_libtsan = 1245,                 /* -static-libtsan */
  OPT_static_libubsan = 1246,                /* -static-libubsan */
  /* OPT_std_c__03 = 1247, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1248, */                /* -std=c++0x */
  OPT_std_c__11 = 1249,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1250, */                /* -std=c++14 */
  OPT_std_c__1y = 1251,                      /* -std=c++1y */
  OPT_std_c__98 = 1252,                      /* -std=c++98 */
  OPT_std_c11 = 1253,                        /* -std=c11 */
  /* OPT_std_c1x = 1254, */                  /* -std=c1x */
  /* OPT_std_c89 = 1255, */                  /* -std=c89 */
  OPT_std_c90 = 1256,                        /* -std=c90 */
  OPT_std_c99 = 1257,                        /* -std=c99 */
  /* OPT_std_c9x = 1258, */                  /* -std=c9x */
  OPT_std_f2003 = 1259,                      /* -std=f2003 */
  OPT_std_f2008 = 1260,                      /* -std=f2008 */
  OPT_std_f2008ts = 1261,                    /* -std=f2008ts */
  OPT_std_f95 = 1262,                        /* -std=f95 */
  OPT_std_gnu = 1263,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1264, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1265, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1266,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1267, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1268,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1269,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1270,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1271, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1272, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1273,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1274,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1275, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1276, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1277,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1278, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1279, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1280, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1281,                     /* -std=legacy */
  OPT_symbolic = 1282,                       /* -symbolic */
  OPT_t = 1283,                              /* -t */
  OPT_time = 1284,                           /* -time */
  OPT_time_ = 1285,                          /* -time= */
  OPT_tno_android_cc = 1286,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1287,                 /* -tno-android-ld */
  OPT_traditional = 1288,                    /* -traditional */
  OPT_traditional_cpp = 1289,                /* -traditional-cpp */
  OPT_trigraphs = 1290,                      /* -trigraphs */
  OPT_u = 1291,                              /* -u */
  OPT_undef = 1292,                          /* -undef */
  OPT_v = 1293,                              /* -v */
  OPT_version = 1294,                        /* -version */
  OPT_w = 1295,                              /* -w */
  OPT_wrapper = 1296,                        /* -wrapper */
  OPT_x = 1297,                              /* -x */
  OPT_z = 1298,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
